const Modal = ({ message, onCloseDeleteModalClick, onDeleteRecordClick }) => {
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-white bg-opacity-50" onClick={onCloseDeleteModalClick}>
      <div className="grid grid-rows-[10%_75%_15%] fixed top-1/2 left-[60%] transform -translate-x-1/2 -translate-y-[60%] border-4 border-slate-700 rounded-lg w-[30%] h-[30%] bg-neutral-50 shadow-slate-600">
